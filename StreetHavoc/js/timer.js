      ...
      element.layout = function() {
        ...
        $.each(units.en, function(i) {
          if (i < config.etLastUnit) {
            ...
            if (config.etShowSign == 1) unit.append('<div class="etSign">' + units.en[i] + '</div>');
            if (config.etShowSign == 2) unit.append('<div class="etSign">' + units.ru[i].toLowerCase() + '</div>');
            if (config.etShowSign == 3) unit.append('<div class="etSign">' + units.az[i] + '</div>');
            if (config.etShowSign == 4) unit.append('<div class="etSign">' + units.tr[i] + '</div>');
          }
        });
